...
library/wordpress/5\
 ...
 library/wordpress/5-fpm\
 library/wordpress/5-fpm-alpine\
 library/wordpress/apache\
 library/wordpress/cli\
 library/wordpress/cli-1\
 library/wordpress/cli-2\
 library/wordpress/fpm\
 library/wordpress/fpm-alpine::7
"
...
gen_image() {
    ...
    ### docker-wordpress
    if ! (echo "$ldir"|grep -E -iq cli);then
